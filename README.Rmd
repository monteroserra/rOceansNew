...
#Visualize abundance
oceanMaps(Carcharhinidae_abundance, logScale=T, main="Carcharhinidae abundance")


# Exploring envioronmental drivers of abundance patterns
abundance_environ_df = oceanEnv(biod_grid = Carcharhinidae_abundance,
                                biodiv_metric = "abundance", 
                                plot=T, 
                                log_scale=T)
...
oceanMaps(Carcharhinidae_diversity[[2]])

# Exploring envioronmental drivers of abundance patterns
abundance_environ_df = oceanEnv(biod_grid = Carcharhinidae_diversity[[2]],
                                biodiv_metric = "richness", 
                                plot=T, 
                                log_scale=T)
