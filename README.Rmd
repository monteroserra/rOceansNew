...
oceanMaps(Acropora_abundance_10x10, logScale=T, main="Acropora abundance (10?)")

oceanMaps(Acropora_abundance_5x5, logScale=T, main="Acropora abundance (5?)")

oceanMaps(Acropora_abundance_1x1, logScale=T, main="Acropora abundance (1?)")

oceanMaps(Acropora_abundance_0.5x0.5, logScale=T, main="Acropora abundance (0.5?)")
...
invisible(abundance_environ_df = oceanEnv(biod_grid = Acropora_abundance,
...
invisible(abundance_environ_df = oceanEnv(biod_grid = Acropora_richness,
...
We can specify any alternative environmental parameters using env_parameters
...
oceanVulnerab(biodiversity_grid = AcroporaHotspots,
...
oceanMaps(Carcharhinidae_abundance_10, logScale=T, main="Carcharhinidae abundance (10?)")

oceanMaps(Carcharhinidae_abundance_5, logScale=T, main="Carcharhinidae abundance (5?)")

oceanMaps(Carcharhinidae_abundance_1, logScale=T, main="Carcharhinidae abundance (1?)")

oceanMaps(Carcharhinidae_abundance_0.5, logScale=T, main="Carcharhinidae abundance (0.5?)")
...
# Exploring envioronmental drivers of abundance patterns
invisible(diversity_env_df = oceanEnv(biod_grid = Carcharhinidae_diversity[[2]],
                                biodiv_metric = "richness", 
                                plot=T, 
                                log_scale=T))
...
oceanVulnerab(biodiversity_grid = Carcharhinidea_hotspots,
              map_climtatic_impacts = F, plot_histograms = T)
